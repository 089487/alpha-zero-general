...
class GTPGo9Player():
    """
    Player that plays with Go9 programs using the Go Text Protocol.
    """

    # The colours are reversed as the Go9 programs seems to have the board setup with the opposite colours
    player_colors = {
        -1: "white",
         1: "black",
    }
    ...
    def notify(self, board, action):
        ...
        """
        color = GTPGo9Player.player_colors[self._currentPlayer]
